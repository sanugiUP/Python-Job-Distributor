...
namespace ClientTwo
{
    ...
    public partial class MainWindow : Window
    {
        ...
        private static int client_two_port_no = 8100;
        private static string client_two_ip = "127.0.0.1";
        ...
        private void registerClient()
        {
            ...
            clientOne.ipaddress = client_two_ip;
            clientOne.portnumber = client_two_port_no;
        ...
        private void serverThreadFunction()
        {
            ...
            host.AddServiceEndpoint(typeof(PythonServerInterface), tcp, "net.tcp://" + client_two_ip + ":" + client_two_port_no + "/PythonJobService");
            host.Open();
        ...
        private void networkThreadFunction()
        {
            ...
            while (true)
            {
                ...
                if (clients != null)
                {
                    ...
                    {
                        /* Ignoring Client One */
                        if (clients[i].portnumber != client_two_port_no)
                        {
                            ...
                            if (!String.IsNullOrEmpty(pythonJob.pythonScript)) /* Check If A Job Is Available */
                            {
                                ...
                                catch (Exception)
                                {
                                    ...
                                    requestThree.AddUrlSegment("id", client_two_port_no);
                                ...
                                if (hash.SequenceEqual(pythonJob.hash))
                                {
                                    ...
                                    if (!String.IsNullOrEmpty(pythonJob.pythonScript))
                                    {
                                        ...
                                        try
                                        {
                                            ...
                                            clientTwo.jobscompleted = jobsTaken;
                                            clientTwo.ipaddress = client_two_ip;
                                            clientTwo.portnumber = client_two_port_no;

                                            RestClient restClient2 = new RestClient("http://localhost:55924/");
                                            RestRequest requestTwo = new RestRequest("api/clients/updateclient/{id}", Method.Put);
                                            requestTwo.AddUrlSegment("id", client_two_port_no);
                                            requestTwo.AddJsonBody(clientTwo);
                                        ...
                                        {
                                            error_msg_diplay.Dispatcher.Invoke(new Action(() => error_msg_diplay.Text = "Error Occured! Incorrect Python Script!"));
                                        }
                                    }
                                    else
                                    {
        ...
        private string CheckForResult(int jobNumber)
        {
            ...
            while (ret_result == null)
            {
                ...
                {
                    if (jobList[i] != null && jobList[i].result != null && jobList[i].jobNumber == jobNumber)
                    {
